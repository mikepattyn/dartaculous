...
const G_GRecipeService_SearchNullable_Return$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 3, '5': 11, '6': '.com.company.project.GRecipe', '10': 'value'},
  ],
};

/// Descriptor for `G_GRecipeService_SearchNullable_Return`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_SearchNullable_ReturnDescriptor = $convert.base64Decode('CiZHX0dSZWNpcGVTZXJ2aWNlX1NlYXJjaE51bGxhYmxlX1JldHVybhIyCgV2YWx1ZRgBIAMoCzIcLmNvbS5jb21wYW55LnByb2plY3QuR1JlY2lwZVIFdmFsdWU=');
...
const G_GRecipeService_GetNullable_Return$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 11, '6': '.com.company.project.GRecipe', '10': 'value'},
  ],
};

/// Descriptor for `G_GRecipeService_GetNullable_Return`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_GetNullable_ReturnDescriptor = $convert.base64Decode('CiNHX0dSZWNpcGVTZXJ2aWNlX0dldE51bGxhYmxlX1JldHVybhIyCgV2YWx1ZRgBIAEoCzIcLmNvbS5jb21wYW55LnByb2plY3QuR1JlY2lwZVIFdmFsdWU=');
...
final $typed_data.Uint8List g_GRecipeService_GetMainRecipeType_ReturnDescriptor = $convert.base64Decode('CilHX0dSZWNpcGVTZXJ2aWNlX0dldE1haW5SZWNpcGVUeXBlX1JldHVybhI3CgV2YWx1ZRgBIAEoDjIhLmNvbS5jb21wYW55LnByb2plY3QuR1JlY2lwZVR5cGVzUgV2YWx1ZQ==');
...
const G_GRecipeService_GetMainRecipeTypeNullable_Return$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 11, '6': '.com.company.project.GRecipeTypes_Message', '10': 'value'},
  ],
};

/// Descriptor for `G_GRecipeService_GetMainRecipeTypeNullable_Return`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_GetMainRecipeTypeNullable_ReturnDescriptor = $convert.base64Decode('CjFHX0dSZWNpcGVTZXJ2aWNlX0dldE1haW5SZWNpcGVUeXBlTnVsbGFibGVfUmV0dXJuEj8KBXZhbHVlGAEgASgLMikuY29tLmNvbXBhbnkucHJvamVjdC5HUmVjaXBlVHlwZXNfTWVzc2FnZVIFdmFsdWU=');
...
const G_GRecipeService_GetRecipeTypeList_Return$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 3, '5': 14, '6': '.com.company.project.GRecipeTypes', '10': 'value'},
  ],
};

/// Descriptor for `G_GRecipeService_GetRecipeTypeList_Return`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_GetRecipeTypeList_ReturnDescriptor = $convert.base64Decode('CilHX0dSZWNpcGVTZXJ2aWNlX0dldFJlY2lwZVR5cGVMaXN0X1JldHVybhI3CgV2YWx1ZRgBIAMoDjIhLmNvbS5jb21wYW55LnByb2plY3QuR1JlY2lwZVR5cGVzUgV2YWx1ZQ==');
...
final $typed_data.Uint8List g_GRecipeService_GetRecipeTypeListNullable_ReturnDescriptor = $convert.base64Decode('CjFHX0dSZWNpcGVTZXJ2aWNlX0dldFJlY2lwZVR5cGVMaXN0TnVsbGFibGVfUmV0dXJuEjcKBXZhbHVlGAEgAygOMiEuY29tLmNvbXBhbnkucHJvamVjdC5HUmVjaXBlVHlwZXNSBXZhbHVl');
...
const G_GRecipeService_ReceiveLotsOfArgs_Parameters$json = const {
  ...
  '2': const [
    ...
    const {'1': 'p_recipe_types', '3': 3, '4': 1, '5': 14, '6': '.com.company.project.GRecipeTypes', '10': 'pRecipeTypes'},
    ...
    const {'1': 'p_list_recipe_types', '3': 7, '4': 3, '5': 14, '6': '.com.company.project.GRecipeTypes', '10': 'pListRecipeTypes'},
    const {'1': 'p_list_recipes', '3': 8, '4': 3, '5': 11, '6': '.com.company.project.GRecipe', '10': 'pListRecipes'},
    const {'1': 'p_set_string', '3': 9, '4': 3, '5': 9, '10': 'pSetString'},
    const {'1': 'p_set_int', '3': 10, '4': 3, '5': 5, '10': 'pSetInt'},
    const {'1': 'p_set_recipe_types', '3': 11, '4': 3, '5': 14, '6': '.com.company.project.GRecipeTypes', '10': 'pSetRecipeTypes'},
    const {'1': 'p_set_recipe', '3': 12, '4': 3, '5': 11, '6': '.com.company.project.GRecipe', '10': 'pSetRecipe'},
    const {'1': 'p_iterable_string', '3': 13, '4': 3, '5': 9, '10': 'pIterableString'},
    const {'1': 'p_iterable_int', '3': 14, '4': 3, '5': 5, '10': 'pIterableInt'},
    const {'1': 'p_iterable_recipe_types', '3': 15, '4': 3, '5': 14, '6': '.com.company.project.GRecipeTypes', '10': 'pIterableRecipeTypes'},
    const {'1': 'p_iterable_recipe', '3': 16, '4': 3, '5': 11, '6': '.com.company.project.GRecipe', '10': 'pIterableRecipe'},
  ],
};

/// Descriptor for `G_GRecipeService_ReceiveLotsOfArgs_Parameters`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_ReceiveLotsOfArgs_ParametersDescriptor = $convert.base64Decode('');

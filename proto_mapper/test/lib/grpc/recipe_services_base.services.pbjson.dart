...
final $typed_data.Uint8List g_GRecipeService_GetMainRecipeType_ReturnDescriptor = $convert.base64Decode('CilHX0dSZWNpcGVTZXJ2aWNlX0dldE1haW5SZWNpcGVUeXBlX1JldHVybhIjCgV2YWx1ZRgBIAEoDjINLkdSZWNpcGVUeXBlc1IFdmFsdWU=');
...
final $typed_data.Uint8List g_GRecipeService_GetRecipeTypeList_ReturnDescriptor = $convert.base64Decode('CilHX0dSZWNpcGVTZXJ2aWNlX0dldFJlY2lwZVR5cGVMaXN0X1JldHVybhIjCgV2YWx1ZRgBIAMoDjINLkdSZWNpcGVUeXBlc1IFdmFsdWU=');
...
const G_GRecipeService_ReceiveLotsOfArgs_Parameters$json = const {
  ...
  '2': const [
    ...
    const {'1': 'p_recipe_types', '3': 3, '4': 1, '5': 14, '6': '.GRecipeTypes', '10': 'pRecipeTypes'},
    const {'1': 'p_recipe', '3': 4, '4': 1, '5': 11, '6': '.GRecipe', '10': 'pRecipe'},
    const {'1': 'p_list_strings', '3': 5, '4': 3, '5': 9, '10': 'pListStrings'},
    const {'1': 'p_list_ints', '3': 6, '4': 3, '5': 5, '10': 'pListInts'},
    const {'1': 'p_list_recipe_types', '3': 7, '4': 3, '5': 14, '6': '.GRecipeTypes', '10': 'pListRecipeTypes'},
    const {'1': 'p_list_recipes', '3': 8, '4': 3, '5': 11, '6': '.GRecipe', '10': 'pListRecipes'},
    const {'1': 'p_set_string', '3': 9, '4': 3, '5': 9, '10': 'pSetString'},
    const {'1': 'p_set_int', '3': 10, '4': 3, '5': 5, '10': 'pSetInt'},
    const {'1': 'p_set_recipe_types', '3': 11, '4': 3, '5': 14, '6': '.GRecipeTypes', '10': 'pSetRecipeTypes'},
    const {'1': 'p_set_recipe', '3': 12, '4': 3, '5': 11, '6': '.GRecipe', '10': 'pSetRecipe'},
    const {'1': 'p_iterable_string', '3': 13, '4': 3, '5': 9, '10': 'pIterableString'},
    const {'1': 'p_iterable_int', '3': 14, '4': 3, '5': 5, '10': 'pIterableInt'},
    const {'1': 'p_iterable_recipe_types', '3': 15, '4': 3, '5': 14, '6': '.GRecipeTypes', '10': 'pIterableRecipeTypes'},
    const {'1': 'p_iterable_recipe', '3': 16, '4': 3, '5': 11, '6': '.GRecipe', '10': 'pIterableRecipe'},
  ],
};

/// Descriptor for `G_GRecipeService_ReceiveLotsOfArgs_Parameters`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List g_GRecipeService_ReceiveLotsOfArgs_ParametersDescriptor = $convert.base64Decode('');

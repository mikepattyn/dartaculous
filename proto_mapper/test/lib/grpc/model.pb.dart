...
class Int64Value extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Int64Value', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'com.company.project'), createEmptyInstance: create)
...
class GRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'com.company.project'), createEmptyInstance: create)
    ...
    ..aOM<Int64Value>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expiryDate', subBuilder: Int64Value.create)
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preparationDuration')
    ..aOM<Int64Value>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalDuration', subBuilder: Int64Value.create)
  ...
  factory GRecipe({
    ...
    Int64Value? expiryDate,
    $fixnum.Int64? preparationDuration,
    Int64Value? totalDuration,
  ...
  @$pb.TagNumber(7)
  Int64Value get expiryDate => $_getN(5);
  @$pb.TagNumber(7)
  set expiryDate(Int64Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasExpiryDate() => $_has(5);
  @$pb.TagNumber(7)
  void clearExpiryDate() => clearField(7);
  @$pb.TagNumber(7)
  Int64Value ensureExpiryDate() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  Int64Value get totalDuration => $_getN(7);
  @$pb.TagNumber(9)
  set totalDuration(Int64Value v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTotalDuration() => $_has(7);
  @$pb.TagNumber(9)
  void clearTotalDuration() => clearField(9);
  @$pb.TagNumber(9)
  Int64Value ensureTotalDuration() => $_ensure(7);
...
class GChef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GChef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'com.company.project'), createEmptyInstance: create)
    ...
    ..aOM<Int64Value>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shelfLife', subBuilder: Int64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  Int64Value get shelfLife => $_getN(5);
  @$pb.TagNumber(7)
  set shelfLife(Int64Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasShelfLife() => $_has(5);
  @$pb.TagNumber(7)
  void clearShelfLife() => clearField(7);
  @$pb.TagNumber(7)
  Int64Value ensureShelfLife() => $_ensure(5);
}
...
class GInventory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GInventory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'com.company.project'), createEmptyInstance: create)
    ...
    ..aOM<Int64Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSpan', subBuilder: Int64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  Int64Value get timeSpan => $_getN(2);
  @$pb.TagNumber(4)
  set timeSpan(Int64Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTimeSpan() => $_has(2);
  @$pb.TagNumber(4)
  void clearTimeSpan() => clearField(4);
  @$pb.TagNumber(4)
  Int64Value ensureTimeSpan() => $_ensure(2);
}

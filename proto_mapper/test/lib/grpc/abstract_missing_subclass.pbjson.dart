...
const GListOfAbstractParentClass1$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GAbstractParentClass1', '10': 'items'},
  ],
};
...
const GAbstractParentClass2$json = const {
  ...
  '2': const [
    const {'1': 'sub_class1', '3': 1, '4': 1, '5': 11, '6': '.GSubClass1', '9': 0, '10': 'subClass1'},
  ],
  '8': const [
    const {'1': 'props'},
  ],
...
final $typed_data.Uint8List gAbstractParentClass2Descriptor = $convert.base64Decode('ChVHQWJzdHJhY3RQYXJlbnRDbGFzczISLAoKc3ViX2NsYXNzMRgBIAEoCzILLkdTdWJDbGFzczFIAFIJc3ViQ2xhc3MxQgcKBXByb3Bz');
...
const GListOfAbstractParentClass2$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GAbstractParentClass2', '10': 'items'},
  ],
};

/// Descriptor for `GListOfAbstractParentClass2`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfAbstractParentClass2Descriptor = $convert.base64Decode('ChtHTGlzdE9mQWJzdHJhY3RQYXJlbnRDbGFzczISLAoFaXRlbXMYASADKAsyFi5HQWJzdHJhY3RQYXJlbnRDbGFzczJSBWl0ZW1z');
...
final $typed_data.Uint8List gSubClass1Descriptor = $convert.base64Decode('CgpHU3ViQ2xhc3Mx');
@$core.Deprecated('Use gListOfSubClass1Descriptor instead')
const GListOfSubClass1$json = const {
  '1': 'GListOfSubClass1',
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GSubClass1', '10': 'items'},
  ],
};

/// Descriptor for `GListOfSubClass1`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfSubClass1Descriptor = $convert.base64Decode('ChBHTGlzdE9mU3ViQ2xhc3MxEiEKBWl0ZW1zGAEgAygLMgsuR1N1YkNsYXNzMVIFaXRlbXM=');

...
class GApplianceType extends $pb.ProtobufEnum {
  static const GApplianceType G_APPLIANCE_TYPE_HEAT = GApplianceType._(0, _omitEnumNames ? '' : 'G_APPLIANCE_TYPE_HEAT');
  static const GApplianceType G_APPLIANCE_TYPE_COLD = GApplianceType._(1, _omitEnumNames ? '' : 'G_APPLIANCE_TYPE_COLD');
  static const GApplianceType G_APPLIANCE_TYPE_CUTLERY = GApplianceType._(2, _omitEnumNames ? '' : 'G_APPLIANCE_TYPE_CUTLERY');
...
class GRecipeTypes extends $pb.ProtobufEnum {
  static const GRecipeTypes G_RECIPE_TYPES_COOK = GRecipeTypes._(0, _omitEnumNames ? '' : 'G_RECIPE_TYPES_COOK');
  static const GRecipeTypes G_RECIPE_TYPES_GRILL = GRecipeTypes._(1, _omitEnumNames ? '' : 'G_RECIPE_TYPES_GRILL');
  static const GRecipeTypes G_RECIPE_TYPES_FRY = GRecipeTypes._(2, _omitEnumNames ? '' : 'G_RECIPE_TYPES_FRY');
  static const GRecipeTypes G_RECIPE_TYPES_STEW = GRecipeTypes._(3, _omitEnumNames ? '' : 'G_RECIPE_TYPES_STEW');
...
class GKnifeType extends $pb.ProtobufEnum {
  static const GKnifeType G_KNIFE_TYPE_CHEFS_KNIFE = GKnifeType._(0, _omitEnumNames ? '' : 'G_KNIFE_TYPE_CHEFS_KNIFE');
  static const GKnifeType G_KNIFE_TYPE_PARING_KNIFE = GKnifeType._(1, _omitEnumNames ? '' : 'G_KNIFE_TYPE_PARING_KNIFE');
  static const GKnifeType G_KNIFE_TYPE_BREAD_KNIFE = GKnifeType._(2, _omitEnumNames ? '' : 'G_KNIFE_TYPE_BREAD_KNIFE');
...
class GChefType extends $pb.ProtobufEnum {
  static const GChefType G_CHEF_TYPE_SENIOR_CHEF = GChefType._(0, _omitEnumNames ? '' : 'G_CHEF_TYPE_SENIOR_CHEF');
  static const GChefType G_CHEF_TYPE_SOUS_CHEF = GChefType._(1, _omitEnumNames ? '' : 'G_CHEF_TYPE_SOUS_CHEF');
  static const GChefType G_CHEF_TYPE_PASTRY_CHEF = GChefType._(2, _omitEnumNames ? '' : 'G_CHEF_TYPE_PASTRY_CHEF');
  static const GChefType G_CHEF_TYPE_FISH_CHEF = GChefType._(3, _omitEnumNames ? '' : 'G_CHEF_TYPE_FISH_CHEF');

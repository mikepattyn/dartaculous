...
class GScheduleConstraint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GScheduleConstraint', createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<GContestConstraint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contestConstraint', subBuilder: GContestConstraint.create)
  ...
  @$pb.TagNumber(1)
  set contestConstraint(GContestConstraint v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GListOfScheduleConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfScheduleConstraint', createEmptyInstance: create)
...
class GConstraintAdded extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GConstraintAdded', createEmptyInstance: create)
...
class GListOfConstraintAdded extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfConstraintAdded', createEmptyInstance: create)
...
class GContestConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GContestConstraint', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GListOfContestConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfContestConstraint', createEmptyInstance: create)

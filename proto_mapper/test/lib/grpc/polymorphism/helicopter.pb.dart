...
class GHelicopter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GHelicopter', createEmptyInstance: create)
  ...
  @$pb.TagNumber(2)
  set serviceCeiling($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
...
class GListOfHelicopter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfHelicopter', createEmptyInstance: create)

...
const GListOfStarship$json = const {
  '1': 'GListOfStarship',
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GStarship', '10': 'items'},
  ],
};

/// Descriptor for `GListOfStarship`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfStarshipDescriptor = $convert.base64Decode('Cg9HTGlzdE9mU3RhcnNoaXASIAoFaXRlbXMYASADKAsyCi5HU3RhcnNoaXBSBWl0ZW1z');

...
GChef _$ChefToProto(Chef instance) {
  ...
  if (instance.shelfLife != null) {
    proto.shelfLife =
        Int64Value(value: Int64(instance.shelfLife!.inMicroseconds));
  }
...
Chef _$ChefFromProto(GChef proto) {
  return Chef(
    ...
    shelfLife: (proto.hasShelfLife()
        ? Duration(microseconds: proto.shelfLife.value.toInt())
        : null),
  );
}
...
GInventory _$InventoryToProto(Inventory instance) {
  ...
  if (instance.timeSpan != null) {
    proto.timeSpan =
        Int64Value(value: Int64(instance.timeSpan!.inMicroseconds));
  }
...
Inventory _$InventoryFromProto(GInventory proto) {
  return Inventory(
    ...
    timeSpan: (proto.hasTimeSpan()
        ? Duration(microseconds: proto.timeSpan.value.toInt())
        : null),
  );
}

...
const GAnimal$json = const {
  '1': 'GAnimal',
  '2': const [
    const {'1': 'fieldsOfSuperClass', '3': 1, '4': 1, '5': 11, '6': '.squarealfa.nozard.techlog.GBeing', '10': 'fieldsOfSuperClass'},
    const {'1': 'height', '3': 2, '4': 1, '5': 5, '10': 'height'},
  ],
};

/// Descriptor for `GAnimal`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gAnimalDescriptor = $convert.base64Decode('CgdHQW5pbWFsElEKEmZpZWxkc09mU3VwZXJDbGFzcxgBIAEoCzIhLnNxdWFyZWFsZmEubm96YXJkLnRlY2hsb2cuR0JlaW5nUhJmaWVsZHNPZlN1cGVyQ2xhc3MSFgoGaGVpZ2h0GAIgASgFUgZoZWlnaHQ=');
...
final $typed_data.Uint8List gBeingDescriptor = $convert.base64Decode('CgZHQmVpbmcSEgoEbWFzcxgCIAEoAVIEbWFzcw==');

...
GConstraintAdded _$ConstraintAddedToProto(ConstraintAdded instance) {
  ...
  proto.contestScheduleId = instance.contestScheduleId;
  proto.constraint =
      const $ScheduleConstraintProtoMapper().toProto(instance.constraint);
...
ConstraintAdded _$ConstraintAddedFromProto(GConstraintAdded instance) =>
    ConstraintAdded()
      ..contestScheduleId = instance.contestScheduleId
      ..constraint =
          const $ScheduleConstraintProtoMapper().fromProto(instance.constraint);

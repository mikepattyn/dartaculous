...
class GAbstractParentClass1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GAbstractParentClass1', createEmptyInstance: create)
...
class GListOfAbstractParentClass1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfAbstractParentClass1', createEmptyInstance: create)
...
class GAbstractParentClass2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GAbstractParentClass2', createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<GSubClass1>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subClass1', subBuilder: GSubClass1.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set subClass1(GSubClass1 v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GListOfAbstractParentClass2 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfAbstractParentClass2', createEmptyInstance: create)
...
class GSubClass1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GSubClass1', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GListOfSubClass1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GListOfSubClass1', createEmptyInstance: create)

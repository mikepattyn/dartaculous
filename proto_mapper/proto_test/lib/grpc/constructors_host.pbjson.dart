...
const GListOfConstructObject1$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject1', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject1`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject1Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0MRIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3QxUgVpdGVtcw==');
...
const GListOfConstructObject2$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject2', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject2`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject2Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0MhIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3QyUgVpdGVtcw==');
...
const GListOfConstructObject3$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject3', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject3`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject3Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0MxIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3QzUgVpdGVtcw==');
...
const GListOfConstructObject4$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject4', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject4`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject4Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0NBIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3Q0UgVpdGVtcw==');
...
const GListOfConstructObject5$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject5', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject5`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject5Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0NRIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3Q1UgVpdGVtcw==');
...
const GListOfConstructObject6$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject6', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject6`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject6Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0NhIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3Q2UgVpdGVtcw==');
...
const GListOfConstructObject7$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject7', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject7`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject7Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0NxIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3Q3UgVpdGVtcw==');
...
const GListOfConstructObject8$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.GConstructObject8', '10': 'items'},
  ],
};

/// Descriptor for `GListOfConstructObject8`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gListOfConstructObject8Descriptor = $convert.base64Decode('ChdHTGlzdE9mQ29uc3RydWN0T2JqZWN0OBIoCgVpdGVtcxgBIAMoCzISLkdDb25zdHJ1Y3RPYmplY3Q4UgVpdGVtcw==');

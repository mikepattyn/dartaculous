...
enum GRotorcraft_Props { helicopter, gyrocopter, notSet }
...
class GRotorcraft extends $pb.GeneratedMessage {
  ...
  factory GRotorcraft.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GRotorcraft.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  GRotorcraft copyWith(void Function(GRotorcraft) updates) =>
      super.copyWith((message) => updates(message as GRotorcraft))
          as GRotorcraft; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static GRotorcraft getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GRotorcraft>(create);
  ...
  @$pb.TagNumber(1)
  $11.GHelicopter get helicopter => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $11.GHelicopter ensureHelicopter() => $_ensure(0);

  @$pb.TagNumber(2)
  $12.GGyrocopter get gyrocopter => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $12.GGyrocopter ensureGyrocopter() => $_ensure(1);
}
...
class GListOfRotorcraft extends $pb.GeneratedMessage {
  ...
  factory GListOfRotorcraft.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GListOfRotorcraft.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GListOfRotorcraft copyWith(void Function(GListOfRotorcraft) updates) =>
      super.copyWith((message) => updates(message as GListOfRotorcraft))
          as GListOfRotorcraft; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GListOfRotorcraft create() => GListOfRotorcraft._();
  GListOfRotorcraft createEmptyInstance() => create();
  static $pb.PbList<GListOfRotorcraft> createRepeated() =>
      $pb.PbList<GListOfRotorcraft>();
  @$core.pragma('dart2js:noInline')
  static GListOfRotorcraft getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GListOfRotorcraft>(create);

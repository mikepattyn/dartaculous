...
class DbClient {
  ...
  factory DbClient.fromConnectionString(
  ...
  Future<DbInfoResult> currentDatabase() async {
  ...
  Future<List<String>> userDatabases() async {
  ...
  Future<List<String>> existingDatabases() async {
  ...
  Future<bool> createDatabase(CreateDatabaseInfo databaseInfo) async {
    final info = {
    ...
    final response = await _httpPost(['_db', db, '_api', 'database'], info);
    final result = _toResultResponse(response);
    return result;
  }
  ...
  Future<bool> dropDatabase(String name) async {
    final response = await _httpDelete(['_db', db, '_api', 'database', name]);
    return _toResultResponse(response);
  }
  ...
  Future<IndexInfo> createPersistentIndex(IndexCriteria criteria) async {
    final answer = await _httpPost([
      '_db',
      db,
      '_api',
  ...
  Future<CollectionInfo> truncateCollection(
    String name, {
  ...
  Future<CollectionInfo> collectionInfo(String name) async {
  ...
  Future<CollectionPropertiesResult> collectionProperties(String name) async {
    var answer =
  ...
  Future<CollectionPropertiesResult> documentsCount(
  ...
  Future<CollectionPropertiesResult> collectionStatistics(
  ...
  Future<CollectionPropertiesResult> collectionRevisionId(
      String collectionName) async {
    final answer = await _httpGet(
  ...
  Future<CollectionInfo> collectionChecksum(String collectionName) async {
    final answer = await _httpGet(
  ...
  Future<List<CollectionInfo>> allCollections() async {
  ...
  Future<DocumentOperationResult> createDocument(
    String collectionName,
  ...
  Future<List<DocumentOperationResult>> createDocuments(
    String collectionName,
  ...
  Future<Map<String, dynamic>> getDocumentByKey(
    String collection,
    String documentKey, {
  ...
  Future<DocumentOperationResult> replaceDocument(
    String collectionName,
    String documentKey,
    Map<String, dynamic> data, {
    String? ifMatchRevision,
  ...
  Future<List<DocumentOperationResult>> replaceDocuments(
    String collectionName,
    List<Map<String, dynamic>> data, {
    Map<String, dynamic> queryParams = const {},
    Transaction? transaction,
  ...
  Future<DocumentOperationResult> updateDocument(
    String collectionName,
    String documentKey,
    Map<String, dynamic> data, {
    String? ifMatchRevision,
  ...
  Future<DocumentOperationResult> removeDocument(
    String collectionName,
    String documentKey, {
    String? ifMatchRevision,
    Map<String, dynamic> queryParams = const {},
  ...
  Future<List<DocumentOperationResult>> removeDocuments(
    String collectionName,
    List<Map<String, dynamic>> data, {
    Map<String, dynamic> queryParams = const {},
    Transaction? transaction,
  ...
  Future<Transaction> commitTransaction(Transaction transaction) async {
    final answer =
  ...
  Future<Transaction> abortTransaction(Transaction transaction) async {
    final answer =
  ...
  static T _toResultResponse<T>(
    ...
    _throwOnError(map);
    final response = convert == null ? map['result'] : convert(map['result']);
    return response;
  }
  ...
  static String _toIdResponse(Map<String, dynamic> map) {
    _throwOnError(map);
    final id = map['id'];
    return id;
  }

  static Transaction _toTransactionResponse(Map<String, dynamic> map) {
    _throwOnError(map);
  ...
  static CollectionInfo _toCollectionResponse(Map<String, dynamic> map) {
    _throwOnError(map);
    final info = _toCollectionInfo(map);
    return info;
  }

  static CollectionPropertiesResult _toCollectionPropertiesResult(
      Map<String, dynamic> map) {
    _throwOnError(map);
    return CollectionPropertiesResult(
  ...
  static IndexInfo _toIndexResult(Map<String, dynamic> map) {
    _throwOnError(map);
  ...
  static DocumentOperationResult _toOperationResult(Map<String, dynamic>? map) {
    _throwOnError(map);

...
class DefaultsProviderGenerator
  ...
  static String generateDefaultsProvider(
    ...
    final superClassConstructorFields = _getFieldDescriptors(
        superTypeElement, 'Object' != superTypeElement.displayName);
    final superClassHasDefaultsProvider =
        superTypeAnnotation != null && superClassConstructorFields.isNotEmpty;

...
class MyMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MyMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto2_preserve_unknown_enum_unittest'), createEmptyInstance: create)
    ...
    ..pc<MyEnum>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedE', $pb.PbFieldType.PE, valueOf: MyEnum.valueOf, enumValues: MyEnum.values, defaultEnumValue: MyEnum.FOO)
    ...
    ..pc<MyEnum>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedPackedUnexpectedE', $pb.PbFieldType.PE, valueOf: MyEnum.valueOf, enumValues: MyEnum.values, defaultEnumValue: MyEnum.FOO)

...
class PublicImportMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicImportMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest_import'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PublicImportMessage copyWith(void Function(PublicImportMessage) updates) => super.copyWith((message) => updates(message as PublicImportMessage)) as PublicImportMessage; // ignore: deprecated_member_use

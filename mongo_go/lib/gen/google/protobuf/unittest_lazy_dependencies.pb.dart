...
class ImportedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportedMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest.lazy_imports'), createEmptyInstance: create)
    ..aOM<$18.LazyMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lazyMessage', subBuilder: $18.LazyMessage.create)
  ...
  'Will be removed in next major version')
  ImportedMessage copyWith(void Function(ImportedMessage) updates) => super.copyWith((message) => updates(message as ImportedMessage)) as ImportedMessage; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set lazyMessage($18.LazyMessage v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MessageCustomOption extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageCustomOption', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest.lazy_imports'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MessageCustomOption copyWith(void Function(MessageCustomOption) updates) => super.copyWith((message) => updates(message as MessageCustomOption)) as MessageCustomOption; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MessageCustomOption2 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageCustomOption2', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest.lazy_imports'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MessageCustomOption2 copyWith(void Function(MessageCustomOption2) updates) => super.copyWith((message) => updates(message as MessageCustomOption2)) as MessageCustomOption2; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

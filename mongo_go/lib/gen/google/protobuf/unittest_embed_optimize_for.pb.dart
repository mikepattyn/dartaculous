...
class TestEmbedOptimizedForSize extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestEmbedOptimizedForSize', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ..aOM<$16.TestOptimizedForSize>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalMessage', subBuilder: $16.TestOptimizedForSize.create)
    ..pc<$16.TestOptimizedForSize>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedMessage', $pb.PbFieldType.PM, subBuilder: $16.TestOptimizedForSize.create)
  ;
  ...
  'Will be removed in next major version')
  TestEmbedOptimizedForSize copyWith(void Function(TestEmbedOptimizedForSize) updates) => super.copyWith((message) => updates(message as TestEmbedOptimizedForSize)) as TestEmbedOptimizedForSize; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set optionalMessage($16.TestOptimizedForSize v) { setField(1, v); }
  @$pb.TagNumber(1)

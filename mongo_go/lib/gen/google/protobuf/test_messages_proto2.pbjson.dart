...
const NullHypothesisProto2$json = const {
  '1': 'NullHypothesisProto2',
};

/// Descriptor for `NullHypothesisProto2`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List nullHypothesisProto2Descriptor = $convert.base64Decode('ChROdWxsSHlwb3RoZXNpc1Byb3RvMg==');
@$core.Deprecated('Use enumOnlyProto2Descriptor instead')
const EnumOnlyProto2$json = const {
  '1': 'EnumOnlyProto2',
  '4': const [EnumOnlyProto2_Bool$json],
};

@$core.Deprecated('Use enumOnlyProto2Descriptor instead')
const EnumOnlyProto2_Bool$json = const {
  '1': 'Bool',
  '2': const [
    const {'1': 'kFalse', '2': 0},
    const {'1': 'kTrue', '2': 1},
...
final $typed_data.Uint8List enumOnlyProto2Descriptor = $convert.base64Decode('Cg5FbnVtT25seVByb3RvMiIdCgRCb29sEgoKBmtGYWxzZRAAEgkKBWtUcnVlEAE=');
@$core.Deprecated('Use oneStringProto2Descriptor instead')
const OneStringProto2$json = const {
  '1': 'OneStringProto2',
  '2': const [
...
final $typed_data.Uint8List oneStringProto2Descriptor = $convert.base64Decode('Cg9PbmVTdHJpbmdQcm90bzISEgoEZGF0YRgBIAEoCVIEZGF0YQ==');

...
class TestAllTypesProto3 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestAllTypesProto3', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_test_messages.proto3'), createEmptyInstance: create)
    ...
    ..pc<TestAllTypesProto3_NestedEnum>(51, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedNestedEnum', $pb.PbFieldType.KE, valueOf: TestAllTypesProto3_NestedEnum.valueOf, enumValues: TestAllTypesProto3_NestedEnum.values, defaultEnumValue: TestAllTypesProto3_NestedEnum.FOO)
    ..pc<ForeignEnum>(52, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedForeignEnum', $pb.PbFieldType.KE, valueOf: ForeignEnum.valueOf, enumValues: ForeignEnum.values, defaultEnumValue: ForeignEnum.FOREIGN_FOO)
    ...
    ..pc<TestAllTypesProto3_NestedEnum>(88, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packedNestedEnum', $pb.PbFieldType.KE, valueOf: TestAllTypesProto3_NestedEnum.valueOf, enumValues: TestAllTypesProto3_NestedEnum.values, defaultEnumValue: TestAllTypesProto3_NestedEnum.FOO)
    ...
    ..pc<TestAllTypesProto3_NestedEnum>(102, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unpackedNestedEnum', $pb.PbFieldType.PE, valueOf: TestAllTypesProto3_NestedEnum.valueOf, enumValues: TestAllTypesProto3_NestedEnum.values, defaultEnumValue: TestAllTypesProto3_NestedEnum.FOO)
...
class NullHypothesisProto3 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NullHypothesisProto3', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_test_messages.proto3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  NullHypothesisProto3._() : super();
  factory NullHypothesisProto3() => create();
  factory NullHypothesisProto3.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NullHypothesisProto3.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NullHypothesisProto3 clone() => NullHypothesisProto3()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NullHypothesisProto3 copyWith(void Function(NullHypothesisProto3) updates) => super.copyWith((message) => updates(message as NullHypothesisProto3)) as NullHypothesisProto3; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NullHypothesisProto3 create() => NullHypothesisProto3._();
  NullHypothesisProto3 createEmptyInstance() => create();
  static $pb.PbList<NullHypothesisProto3> createRepeated() => $pb.PbList<NullHypothesisProto3>();
  @$core.pragma('dart2js:noInline')
  static NullHypothesisProto3 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NullHypothesisProto3>(create);
  static NullHypothesisProto3? _defaultInstance;
}

class EnumOnlyProto3 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnumOnlyProto3', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_test_messages.proto3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  EnumOnlyProto3._() : super();
  factory EnumOnlyProto3() => create();
  factory EnumOnlyProto3.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EnumOnlyProto3.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EnumOnlyProto3 copyWith(void Function(EnumOnlyProto3) updates) => super.copyWith((message) => updates(message as EnumOnlyProto3)) as EnumOnlyProto3; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EnumOnlyProto3 create() => EnumOnlyProto3._();
  EnumOnlyProto3 createEmptyInstance() => create();
  static $pb.PbList<EnumOnlyProto3> createRepeated() => $pb.PbList<EnumOnlyProto3>();
  @$core.pragma('dart2js:noInline')
  static EnumOnlyProto3 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EnumOnlyProto3>(create);

...
class MyEnumPlusExtra extends $pb.ProtobufEnum {
  static const MyEnumPlusExtra E_FOO = MyEnumPlusExtra._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'E_FOO');
  static const MyEnumPlusExtra E_BAR = MyEnumPlusExtra._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'E_BAR');
  static const MyEnumPlusExtra E_BAZ = MyEnumPlusExtra._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'E_BAZ');
  static const MyEnumPlusExtra E_EXTRA = MyEnumPlusExtra._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'E_EXTRA');

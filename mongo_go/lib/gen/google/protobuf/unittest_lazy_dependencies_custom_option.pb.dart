...
class LazyMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LazyMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest.lazy_imports'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LazyMessage copyWith(void Function(LazyMessage) updates) => super.copyWith((message) => updates(message as LazyMessage)) as LazyMessage; // ignore: deprecated_member_use
...
class Unittest_lazy_dependencies_custom_option {
  static final lazyEnumOption = $pb.Extension<$17.LazyEnum>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.MessageOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lazyEnumOption', 138596335, $pb.PbFieldType.OE, defaultOrMaker: $17.LazyEnum.LAZY_ENUM_1, valueOf: $17.LazyEnum.valueOf, enumValues: $17.LazyEnum.values);

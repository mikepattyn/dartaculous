...
class ForeignEnum extends $pb.ProtobufEnum {
  static const ForeignEnum FOREIGN_ZERO = ForeignEnum._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FOREIGN_ZERO');
...
class TestAllTypes_NestedEnum extends $pb.ProtobufEnum {
  static const TestAllTypes_NestedEnum ZERO = TestAllTypes_NestedEnum._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ZERO');
...
class TestOneof2_NestedEnum extends $pb.ProtobufEnum {
  static const TestOneof2_NestedEnum UNKNOWN = TestOneof2_NestedEnum._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');

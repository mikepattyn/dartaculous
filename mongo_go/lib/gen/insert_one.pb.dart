...
class InsertOneRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InsertOneRequest', createEmptyInstance: create)
  ...
  factory InsertOneRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InsertOneRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  InsertOneRequest copyWith(void Function(InsertOneRequest) updates) => super.copyWith((message) => updates(message as InsertOneRequest)) as InsertOneRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InsertOneRequest create() => InsertOneRequest._();
  InsertOneRequest createEmptyInstance() => create();
  static $pb.PbList<InsertOneRequest> createRepeated() => $pb.PbList<InsertOneRequest>();
  @$core.pragma('dart2js:noInline')
  static InsertOneRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InsertOneRequest>(create);
...
class InsertOneResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InsertOneResult', createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insertedId', $pb.PbFieldType.OY, protoName: 'insertedId')
    ..hasRequiredFields = false
  ;
  ...
  factory InsertOneResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InsertOneResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InsertOneResult copyWith(void Function(InsertOneResult) updates) => super.copyWith((message) => updates(message as InsertOneResult)) as InsertOneResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InsertOneResult create() => InsertOneResult._();
  InsertOneResult createEmptyInstance() => create();
  static $pb.PbList<InsertOneResult> createRepeated() => $pb.PbList<InsertOneResult>();
  @$core.pragma('dart2js:noInline')
  static InsertOneResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InsertOneResult>(create);
  static InsertOneResult? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get insertedId => $_getN(0);
  @$pb.TagNumber(1)
  set insertedId($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)

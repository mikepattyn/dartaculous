...
//  source: mongo_proxy/end_transaction_request.proto
//
// @dart = 2.12
...
class EndTransactionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndTransactionRequest', createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionOid', $pb.PbFieldType.OY, protoName: 'transactionOid')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorMessage', protoName: 'errorMessage')
  ...
  factory EndTransactionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EndTransactionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  EndTransactionRequest clone() => EndTransactionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndTransactionRequest copyWith(void Function(EndTransactionRequest) updates) => super.copyWith((message) => updates(message as EndTransactionRequest)) as EndTransactionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EndTransactionRequest create() => EndTransactionRequest._();
  EndTransactionRequest createEmptyInstance() => create();
  static $pb.PbList<EndTransactionRequest> createRepeated() => $pb.PbList<EndTransactionRequest>();
  @$core.pragma('dart2js:noInline')
  static EndTransactionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EndTransactionRequest>(create);
  ...
  @$pb.TagNumber(3)
  set transactionOid($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)

...
class TransactionIdentifier extends $pb.GeneratedMessage {
  ...
  factory TransactionIdentifier.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransactionIdentifier.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TransactionIdentifier clone() =>
      TransactionIdentifier()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TransactionIdentifier copyWith(
          void Function(TransactionIdentifier) updates) =>
      super.copyWith((message) => updates(message as TransactionIdentifier))
          as TransactionIdentifier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TransactionIdentifier create() => TransactionIdentifier._();
  TransactionIdentifier createEmptyInstance() => create();
  static $pb.PbList<TransactionIdentifier> createRepeated() =>
      $pb.PbList<TransactionIdentifier>();
  @$core.pragma('dart2js:noInline')
  static TransactionIdentifier getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransactionIdentifier>(create);

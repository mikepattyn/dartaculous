...
class WithTransactionRequest extends $pb.GeneratedMessage {
  ...
  factory WithTransactionRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WithTransactionRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  WithTransactionRequest clone() =>
      WithTransactionRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  WithTransactionRequest copyWith(
          void Function(WithTransactionRequest) updates) =>
      super.copyWith((message) => updates(message as WithTransactionRequest))
          as WithTransactionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WithTransactionRequest create() => WithTransactionRequest._();
  WithTransactionRequest createEmptyInstance() => create();
  static $pb.PbList<WithTransactionRequest> createRepeated() =>
      $pb.PbList<WithTransactionRequest>();
  @$core.pragma('dart2js:noInline')
  static WithTransactionRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WithTransactionRequest>(create);

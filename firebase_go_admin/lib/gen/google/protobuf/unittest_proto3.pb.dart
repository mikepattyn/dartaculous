  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<TestAllTypes_NestedEnum>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'optionalNestedEnum',
        $pb.PbFieldType.OE,
        defaultOrMaker: TestAllTypes_NestedEnum.ZERO,
    ...
    ..e<ForeignEnum>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'optionalForeignEnum',
        $pb.PbFieldType.OE,
        defaultOrMaker: ForeignEnum.FOREIGN_ZERO,
...
class TestMessageWithDummy extends $pb.GeneratedMessage {
  ...
  factory TestMessageWithDummy.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TestMessageWithDummy.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TestMessageWithDummy clone() =>
      TestMessageWithDummy()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TestMessageWithDummy copyWith(void Function(TestMessageWithDummy) updates) =>
      super.copyWith((message) => updates(message as TestMessageWithDummy))
          as TestMessageWithDummy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TestMessageWithDummy create() => TestMessageWithDummy._();
  TestMessageWithDummy createEmptyInstance() => create();
  static $pb.PbList<TestMessageWithDummy> createRepeated() =>
      $pb.PbList<TestMessageWithDummy>();
  @$core.pragma('dart2js:noInline')
  static TestMessageWithDummy getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TestMessageWithDummy>(create);
  static TestMessageWithDummy? _defaultInstance;

  @$pb.TagNumber(536870911)
  $core.bool get dummy => $_getBF(0);
  @$pb.TagNumber(536870911)
  set dummy($core.bool v) {
    $_setBool(0, v);
  }
...
enum TestOneof2_Foo { fooEnum, notSet }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<TestOneof2_NestedEnum>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'fooEnum',
        $pb.PbFieldType.OE,
        defaultOrMaker: TestOneof2_NestedEnum.UNKNOWN,

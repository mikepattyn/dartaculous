...
class ImportMessageLite extends $pb.GeneratedMessage {
  ...
  factory ImportMessageLite.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ImportMessageLite.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ImportMessageLite copyWith(void Function(ImportMessageLite) updates) =>
      super.copyWith((message) => updates(message as ImportMessageLite))
          as ImportMessageLite; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ImportMessageLite create() => ImportMessageLite._();
  ImportMessageLite createEmptyInstance() => create();
  static $pb.PbList<ImportMessageLite> createRepeated() =>
      $pb.PbList<ImportMessageLite>();
  @$core.pragma('dart2js:noInline')
  static ImportMessageLite getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ImportMessageLite>(create);

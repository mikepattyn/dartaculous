  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'optionalCord')
    ..aOM<TestProto3Optional_NestedMessage>(
        18,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'optionalNestedMessage',
        subBuilder: TestProto3Optional_NestedMessage.create)
    ..aOM<TestProto3Optional_NestedMessage>(
        19,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'lazyNestedMessage',
        subBuilder: TestProto3Optional_NestedMessage.create)
    ..e<TestProto3Optional_NestedEnum>(
        21,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'optionalNestedEnum',
        $pb.PbFieldType.OE,
        defaultOrMaker: TestProto3Optional_NestedEnum.UNSPECIFIED,
        valueOf: TestProto3Optional_NestedEnum.valueOf,
        enumValues: TestProto3Optional_NestedEnum.values)
    ..a<$core.int>(
        22,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''

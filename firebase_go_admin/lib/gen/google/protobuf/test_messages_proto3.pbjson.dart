...
final $typed_data.Uint8List foreignEnumDescriptor = $convert.base64Decode(
    'CgtGb3JlaWduRW51bRIPCgtGT1JFSUdOX0ZPTxAAEg8KC0ZPUkVJR05fQkFSEAESDwoLRk9SRUlHTl9CQVoQAg==');
...
const NullHypothesisProto3$json = const {
...
const EnumOnlyProto3$json = const {
  '1': 'EnumOnlyProto3',
  '4': const [EnumOnlyProto3_Bool$json],
};

@$core.Deprecated('Use enumOnlyProto3Descriptor instead')
const EnumOnlyProto3_Bool$json = const {
  '1': 'Bool',
  '2': const [
    const {'1': 'kFalse', '2': 0},
    const {'1': 'kTrue', '2': 1},

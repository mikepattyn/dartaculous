...
class TestAllTypesProto3_NestedMessage extends $pb.GeneratedMessage {
  ...
  TestAllTypesProto3_NestedMessage copyWith(
      ...
      super.copyWith(
          ...
          as TestAllTypesProto3_NestedMessage; // ignore: deprecated_member_use
...
class TestAllTypesProto3 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$13.NullValue>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'oneofNullValue',
        $pb.PbFieldType.OE,
        defaultOrMaker: $13.NullValue.NULL_VALUE,
        valueOf: $13.NullValue.valueOf,
        enumValues: $13.NullValue.values)
    ..aOM<$9.BoolValue>(
        201,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..pc<$13.ListValue>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'repeatedListValue',
        $pb.PbFieldType.PM,
        subBuilder: $13.ListValue.create)
    ..pc<$13.Struct>(
        324,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  TestAllTypesProto3 copyWith(void Function(TestAllTypesProto3) updates) =>
      super.copyWith((message) => updates(message as TestAllTypesProto3))
          as TestAllTypesProto3; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(120)
  set oneofNullValue($13.NullValue v) {
    setField(120, v);
  }
  ...
  @$pb.TagNumber(201)
  set optionalBoolWrapper($9.BoolValue v) {
    setField(201, v);
  }
  ...
  @$pb.TagNumber(202)
  set optionalInt32Wrapper($9.Int32Value v) {
    setField(202, v);
  }
  ...
  @$pb.TagNumber(203)
  set optionalInt64Wrapper($9.Int64Value v) {
    setField(203, v);
  }
  ...
  @$pb.TagNumber(204)
  set optionalUint32Wrapper($9.UInt32Value v) {
    setField(204, v);
  }
  ...
  @$pb.TagNumber(205)
  set optionalUint64Wrapper($9.UInt64Value v) {
    setField(205, v);
  }
  ...
  @$pb.TagNumber(206)
  set optionalFloatWrapper($9.FloatValue v) {
    setField(206, v);
  }
  ...
  @$pb.TagNumber(207)
  set optionalDoubleWrapper($9.DoubleValue v) {
    setField(207, v);
  }
  ...
  @$pb.TagNumber(208)
  set optionalStringWrapper($9.StringValue v) {
    setField(208, v);
  }
  ...
  @$pb.TagNumber(209)
  set optionalBytesWrapper($9.BytesValue v) {
    setField(209, v);
  }
  ...
  @$pb.TagNumber(301)
  set optionalDuration($10.Duration v) {
    setField(301, v);
  }
  ...
  @$pb.TagNumber(302)
  set optionalTimestamp($11.Timestamp v) {
    setField(302, v);
  }
  ...
  @$pb.TagNumber(303)
  set optionalFieldMask($12.FieldMask v) {
    setField(303, v);
  }
  ...
  @$pb.TagNumber(304)
  set optionalStruct($13.Struct v) {
    setField(304, v);
  }
  ...
  @$pb.TagNumber(307)
  set optionalNullValue($13.NullValue v) {
    setField(307, v);
  }
...
class NullHypothesisProto3 extends $pb.GeneratedMessage {
  ...
  NullHypothesisProto3 copyWith(void Function(NullHypothesisProto3) updates) =>
      super.copyWith((message) => updates(message as NullHypothesisProto3))
          as NullHypothesisProto3; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EnumOnlyProto3 extends $pb.GeneratedMessage {
  ...
  EnumOnlyProto3 copyWith(void Function(EnumOnlyProto3) updates) =>
      super.copyWith((message) => updates(message as EnumOnlyProto3))
          as EnumOnlyProto3; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

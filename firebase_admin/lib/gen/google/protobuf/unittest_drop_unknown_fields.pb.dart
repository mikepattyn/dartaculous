...
class Foo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Foo_NestedEnum>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'enumValue',
        $pb.PbFieldType.OE,
        defaultOrMaker: Foo_NestedEnum.FOO,
        valueOf: Foo_NestedEnum.valueOf,
        enumValues: Foo_NestedEnum.values)
  ...
  Foo copyWith(void Function(Foo) updates) =>
      super.copyWith((message) => updates(message as Foo))
          as Foo; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set enumValue(Foo_NestedEnum v) {
    setField(2, v);
  }
...
class FooWithExtraFields extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'int32Value',
        $pb.PbFieldType.O3)
    ..e<FooWithExtraFields_NestedEnum>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'enumValue',
        $pb.PbFieldType.OE,
        defaultOrMaker: FooWithExtraFields_NestedEnum.FOO,
        valueOf: FooWithExtraFields_NestedEnum.valueOf,
        enumValues: FooWithExtraFields_NestedEnum.values)
    ..a<$core.int>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory FooWithExtraFields.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FooWithExtraFields.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  FooWithExtraFields copyWith(void Function(FooWithExtraFields) updates) =>
      super.copyWith((message) => updates(message as FooWithExtraFields))
          as FooWithExtraFields; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FooWithExtraFields create() => FooWithExtraFields._();
  FooWithExtraFields createEmptyInstance() => create();
  static $pb.PbList<FooWithExtraFields> createRepeated() =>
      $pb.PbList<FooWithExtraFields>();
  @$core.pragma('dart2js:noInline')
  static FooWithExtraFields getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FooWithExtraFields>(create);
  ...
  @$pb.TagNumber(2)
  set enumValue(FooWithExtraFields_NestedEnum v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set extraInt32Value($core.int v) {
    $_setSignedInt32(2, v);
  }

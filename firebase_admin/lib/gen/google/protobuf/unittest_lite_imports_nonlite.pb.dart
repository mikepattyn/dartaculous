...
class TestLiteImportsNonlite extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$8.TestAllTypes>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'message',
        subBuilder: $8.TestAllTypes.create)
    ..aOM<$8.TestRequired>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'messageWithRequired',
        subBuilder: $8.TestRequired.create);
  ...
  factory TestLiteImportsNonlite.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TestLiteImportsNonlite.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TestLiteImportsNonlite clone() =>
      TestLiteImportsNonlite()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TestLiteImportsNonlite copyWith(
          void Function(TestLiteImportsNonlite) updates) =>
      super.copyWith((message) => updates(message as TestLiteImportsNonlite))
          as TestLiteImportsNonlite; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TestLiteImportsNonlite create() => TestLiteImportsNonlite._();
  TestLiteImportsNonlite createEmptyInstance() => create();
  static $pb.PbList<TestLiteImportsNonlite> createRepeated() =>
      $pb.PbList<TestLiteImportsNonlite>();
  @$core.pragma('dart2js:noInline')
  static TestLiteImportsNonlite getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TestLiteImportsNonlite>(create);
  static TestLiteImportsNonlite? _defaultInstance;

  @$pb.TagNumber(1)
  $8.TestAllTypes get message => $_getN(0);
  @$pb.TagNumber(1)
  set message($8.TestAllTypes v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set messageWithRequired($8.TestRequired v) {
    setField(2, v);
  }

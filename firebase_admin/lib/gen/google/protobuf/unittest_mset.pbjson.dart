...
final $typed_data.Uint8List nestedTestMessageSetContainerDescriptor =
    $convert.base64Decode(
        'Ch1OZXN0ZWRUZXN0TWVzc2FnZVNldENvbnRhaW5lchJICgljb250YWluZXIYASABKAsyKi5wcm90b2J1Zl91bml0dGVzdC5UZXN0TWVzc2FnZVNldENvbnRhaW5lclIJY29udGFpbmVyEkYKBWNoaWxkGAIgASgLMjAucHJvdG9idWZfdW5pdHRlc3QuTmVzdGVkVGVzdE1lc3NhZ2VTZXRDb250YWluZXJSBWNoaWxk');
...
const NestedTestInt$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.protobuf_unittest.NestedTestInt',
      '10': 'child'
    },
  ],
};
...
final $typed_data.Uint8List nestedTestIntDescriptor = $convert.base64Decode(
    'Cg1OZXN0ZWRUZXN0SW50EgwKAWEYASABKAdSAWESDAoBYhgDIAEoBVIBYhI2CgVjaGlsZBgCIAEoCzIgLnByb3RvYnVmX3VuaXR0ZXN0Lk5lc3RlZFRlc3RJbnRSBWNoaWxk');
...
const TestMessageSetExtension3$json = const {
  ...
  '6': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.protobuf_unittest.TestMessageSetExtension3',
      '10': 'messageSetExtension'
    },
  ],
};
...
final $typed_data.Uint8List testMessageSetExtension3Descriptor =
    $convert.base64Decode(
        '');

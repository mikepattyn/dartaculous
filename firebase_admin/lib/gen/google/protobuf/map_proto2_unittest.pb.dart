  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$fixnum.Int64, TestIntIntMap>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mSint64',
        entryClassName: 'TestMaps.MSint64Entry',
    ...
    ..m<$core.int, TestIntIntMap>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mFixed32',
        entryClassName: 'TestMaps.MFixed32Entry',
    ...
    ..m<$fixnum.Int64, TestIntIntMap>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mFixed64',
        entryClassName: 'TestMaps.MFixed64Entry',
    ...
    ..m<$core.int, TestIntIntMap>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mSfixed32',
        entryClassName: 'TestMaps.MSfixed32Entry',
    ...
    ..m<$fixnum.Int64, TestIntIntMap>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mSfixed64',
        entryClassName: 'TestMaps.MSfixed64Entry',
        keyFieldType: $pb.PbFieldType.OSF6,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: TestIntIntMap.create,
        packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.bool, TestIntIntMap>(
        11,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mBool',
        entryClassName: 'TestMaps.MBoolEntry',
        keyFieldType: $pb.PbFieldType.OB,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: TestIntIntMap.create,
        packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.String, TestIntIntMap>(
        12,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mString',
        entryClassName: 'TestMaps.MStringEntry',
